...
<div class="item">
	...
	<div class="item__body">
		...
		<? if (!empty($price)): ?>
			<div class="item__price-wrapper" data-entity="price-block">
				<? if ($arParams['SHOW_OLD_PRICE'] === 'Y' && !empty($price) && $price['RATIO_BASE_PRICE'] > $price['RATIO_PRICE']): ?>
					<div class="item__price-label-wrapper">
						<div class="item__price-label">
							<span>-<?= $price["PERCENT"] ?>%</span>
							<span><?= $price["PRINT_DISCOUNT"] ?> Экономия</span>
						</div>
					</div>
					<span class="item__price item__price--old" id="<?= $itemIds['PRICE_OLD'] ?>">
						<?= $price['PRINT_RATIO_BASE_PRICE'] ?>
					</span>
				<? endif; ?>

				<span class="item__price item__price--current" id="<?= $itemIds['PRICE'] ?>">
		...
		<div id="<?= $itemIds['BASKET_ACTIONS'] ?>">
			...
			*/ ?>
			...
			<div class="product-item-info-container product-item-hidden" data-entity="quantity-block">
				<div class="counter">
					<button class="main-btn main-btn--outlined" id="<?= $itemIds['QUANTITY_DOWN'] ?>">-</button>
					<input class="product-item-amount-field" id="<?= $itemIds['QUANTITY'] ?>" type="number"
						name="<?= $arParams['PRODUCT_QUANTITY_VARIABLE'] ?>"
						value="<?= $measureRatio ?>">
					<button class="main-btn main-btn--outlined" id="<?= $itemIds['QUANTITY_UP'] ?>">+</button>
				</div>
			...
			<button class="main-btn" id="<?= $itemIds['BUY_LINK'] ?>">
				В корзину
			</button>
		</div>
