...
<div class="item item--line">
	<div class="item__gallery-wrapper" >
		...
		<div class="item__action">
			<button type="button" aria-label="Быстрый просмотр" class="item__action-btn item__action-btn--with-text item__action-btn--quickview">
				<span  class="item__action-btn-text item__action-btn-text--quickview">Быстрый просмотр</span>
			</button>
			<button type="button" class="item__action-btn item__action-btn--with-text item__action-btn--oneclickbuy">
